...
describe 'navigate' do
  ...
  describe 'index' do
    ...
    it 'has a scope so that only post creators can see their posts' do
      ...
      other_user = User.create(first_name: "Non", last_name: "Authorized", email: "non@example.com", password: "password", password_confirmation: "password")
  ...
  describe 'edit' do
    before do
      ...
      # login_as(user, :scope => :user)
      # @post = FactoryGirl.create(:post)
      @edit_user = User.create(first_name: "Edit", last_name: "User", email: "edituser@example.com", password: "password", password_confirmation: "password")
      login_as(@edit_user, :scope => :user)
      @edit_post = Post.create(date: Date.today, rationale: "whatever", user: @edit_user)
    end
